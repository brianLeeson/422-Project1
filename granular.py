...
def export(decided_teams):
	...
	with open('team_decisions.csv', 'w') as out_file:
		...
		for team in decided_teams:
			print(team.getNumber(), team.get_time_slots())
			fieldnames = ['Team {}'.format(i),
					...
					'team_languages {}'.format(team.get_common_langs())]
...
if __name__ == '__main__':
	...
	#print(translateTime(["10:00-12:00;2:00-4:00", "2:00-4:00;4:00-6:00", "10:00-12:00;4:00-6:00", "None", "10:00-12:00;2:00-4:00"]))
	team1 = Team(1)
	team1.setMemberList(stu_li[0:3])
	team1.add_time_slot("Monday 12:00 - 2:00")
	team1.add_time_slot("Wednesday 2:00 - 4:00")
	team1.set_common_langs('Python')
	team2 = Team(2)
	team2.add_time_slot("Monday 12:00 - 2:00")
	team2.add_time_slot("Wednesday 2:00 - 4:00")
	team2.setMemberList(stu_li[3:6])
	team2.set_common_langs('Java')
	team3 = Team(3)
	team3.setMemberList(stu_li[6:10])
	team3.add_time_slot("Monday 12:00 - 2:00")
	team3.add_time_slot("Wednesday 2:00 - 4:00")
	team3.set_common_langs('SQL')
